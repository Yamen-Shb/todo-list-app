                    ...
                    return ListTile(
                      ...
                      trailing: IconButton(
                        icon: Icon(
                          ...
                          color: task.isCompleted ? Colors.green[300] : null
                        ),
                        onPressed: () {
                                    ...
                                    children: [
                                      ...
                                      onPressed: () {
                                        if (taskTitle.isNotEmpty) {
                                          taskController.renameTask(task, taskTitle); 
                                          Get.back();
                                        }
                                        else {
                                          Get.back();
                        ...
                        return AlertDialog(
                          ...
                          actions: [
                            ...
                            ElevatedButton(
                              onPressed: () {
                                if (taskTitle.isNotEmpty) {
                                  taskController.createNewTask(taskTitle, false);
                                  Get.back();
                                }
                              }, 
